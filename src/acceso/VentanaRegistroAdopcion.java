...
public class VentanaRegistroAdopcion extends JFrame {
    ...
    public static String getRutaImagenesAdoptantes() {
      ...
      public VentanaRegistroAdopcion() throws IOException {
            ...
            btnAdoptarPanel3 = new JButton("Adoptar");
            btnAdoptarPanel3.addMouseListener(new MouseAdapter() {
                  ...
                  public void mouseClicked(MouseEvent e) {
                        ...
                        idMascota = mascotaPanel3.getID();
                        idUsuarioQueCalifica = mascotaPanel3.getIdEncargado();
                        ...
                        imgfotomascotaAdoptar = imgfotomascota3;
            ...
            btnAdoptarPanel2 = new JButton("Adoptar");
            btnAdoptarPanel2.addMouseListener(new MouseAdapter() {
                  ...
                  public void mouseClicked(MouseEvent arg0) {
                        ...
                        idUsuarioActivo=VentanaPrincipal.getIDUsuarioActivo();
                        idMascota = mascotaPanel2.getID();
                        
                        idUsuarioQueCalifica = mascotaPanel2.getIdEncargado();
                        labelRazaMAscotaAdopccion.setText("Raza: "+SistemasMascotas.getRazaDeMascota(idMascota));
                        labelTipoMascotaAdopcion.setText("Tipo: " + SistemasMascotas.getTipoDeMascota(idMascota));
                        labelEncargadoActual.setText("Encargado Actual: " + SistemasUsuarios.getNombreCompletoDelUsuario(idUsuarioQueCalifica));
                        imgfotomascotaAdoptar = imgfotomascota2;
                        labelFotoMascotaAdopcion.setIcon(new ImageIcon(imgfotomascotaAdoptar.getImage().getScaledInstance(106,119,Image.SCALE_SMOOTH)));
                  }
            });
